...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mainView.addSubview(settingsImage)
        mainView.addSubview(myCollectionView)
...
//        section.boundarySupplementaryItems = [header]
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            mainView.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 350),
            ...
            myCollectionView.leadingAnchor.constraint(equalTo: mainView.leadingAnchor, constant: 26),
